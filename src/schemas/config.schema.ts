...
export class Configuracao {
  ...
  // Nome de quem fez a última alteração (vem do JWT do código de acesso
  // usado) — dá rastreabilidade básica de "quem mexeu nas configurações
  // por último", sem precisar de um log completo de auditoria.
  @Prop({ type: String })
...
ConfiguracaoSchema.statics.getConfig = async function () {
  ...
  const defaultConfig = {
    ...
    adminAccessCode:
      '$2b$10$k7LYaWhu/STgumjPBuwRzeNTEuw0rqsbAFUlhE9jJACKvnNgjfU9m', // Hash do admin123
    conteudoSite: {
      heroSlides: [
        {
          image:
        ...
        },
        {
          ...
          subtitle:
            'Estrutura completa, natureza viva e hospitalidade incomparável.',
      ...
      galleryImages: [
        ...
        {
          thumbnail:
            'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=600&h=450&fit=crop',
        ...
        {
          thumbnail:
            'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600&h=450&fit=crop',
      ...
      chaletImages: [
        {
          ...
          description:
            'Chalé aconchegante ideal para famílias, com vista para o jardim e todas as comodidades necessárias para uma estadia confortável.',
        },
        {
          ...
          description:
            'Chalé moderno e elegante, perfeito para executivos que buscam conforto e praticidade durante sua estadia.',
        },
        {
          ...
          title: 'Chalé Premium',
          description:
            'Nosso chalé mais luxuoso, com vista panorâmica e todas as amenidades premium para uma experiência única.',
        },
        {
          ...
          title: 'Chalé Rústico',
          description:
            'Chalé com estilo rústico e charmoso, ideal para quem busca uma experiência mais próxima da natureza.',
        },
      ],
      aboutImage: {
